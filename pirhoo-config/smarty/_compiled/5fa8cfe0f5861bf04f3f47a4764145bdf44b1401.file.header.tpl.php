<?php /* Smarty version Smarty-3.0.6, created on 2011-06-15 14:59:22
         compiled from "/Users/pirhoo/Lab/Web/Influence-Networks/appinc/template/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15683190574df8acaa96a907-23761555%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '15683190574df8acaa96a907-23761555',
  'function' => 
  array (
  ),
...
appinc/javascript/relation-review.js"></script>                  
            ...
            <?php }elseif($_smarty_tpl->getVariable('screen')->value=="relation-visualize"){?>
                    ...
                    <script type="text/javascript" src="<?php echo @APP_URL;?>
appinc/javascript/relation-visualize.js"></script>                  
...
: <input type="password" name="password" class="text" /></label>
                                                <input type="submit" class="submit button violet" value="<?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; smarty_translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
